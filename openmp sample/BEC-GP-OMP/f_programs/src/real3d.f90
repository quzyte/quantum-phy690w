!#  File name : real3d.f90	!# Last modified : 14 Mar 2016
...
!
  ...
  END SELECT
!
  OPEN(17, FILE = 'real3d-out.txt')
  OPEN(14, FILE = 'real3d-rms.txt')
!
  WRITE(17,900) OPTION 
  WRITE(14,900) OPTION 
  WRITE(17,*) 
...
!
  CP2=ABS(CP)**2
  !OPEN(31, FILE = 'real3d-den-init.txt')
  !CALL WRITE_3D(31, CP2)
  !CLOSE(31)

  !OPEN(11, FILE = 'real3d-den-init1d_z.txt')
  !OPEN(12, FILE = 'real3d-den-init1d_x.txt')
  !OPEN(13, FILE = 'real3d-den-init1d_y.txt')
  ...
  !OPEN(21, FILE = 'real3d-den-init2d_xz.txt')
  !OPEN(22, FILE = 'real3d-den-init2d_xy.txt')
  !OPEN(23, FILE = 'real3d-den-init2d_yz.txt')
  ...
  !OPEN(32, FILE = 'real3d-den-init3d_x0z.txt')
  !OPEN(33, FILE = 'real3d-den-init3d_xy0.txt')
...
!
    !OPEN(31, FILE = 'real3d-den-nstp.txt')
    !CALL WRITE_3D(31, CP2)
    !CLOSE(31)

    !OPEN(11, FILE = 'real3d-den-nstp1d_z.txt')
    !OPEN(12, FILE = 'real3d-den-nstp1d_x.txt')
    !OPEN(13, FILE = 'real3d-den-nstp1d_y.txt')
    !CALL DEN1DZ(11, CP2, DEN1Z)
    !CALL DEN1DX(12, CP2, DEN1X)
    !CALL DEN1DY(13, CP2, DEN1Y)
    !CLOSE(11)
    ...
    !OPEN(21, FILE = 'real3d-den-nstp2d_xz.txt')
    !OPEN(22, FILE = 'real3d-den-nstp2d_xy.txt')
    !OPEN(23, FILE = 'real3d-den-nstp2d_yz.txt')
    !CALL DEN2DXZ(21, CP2, DEN2XZ)
    !CALL DEN2DXY(22, CP2, DEN2XY)
    !CALL DEN2DYZ(23, CP2, DEN2YZ)
    !CLOSE(21)
    ...
    !OPEN(32, FILE = 'real3d-den-nstp3d_x0z.txt')
    !OPEN(33, FILE = 'real3d-den-nstp3d_xy0.txt')
    !CALL WRITE_2DXZ(32, CP2)
    !CALL WRITE_2DXY(33, CP2)
    !CLOSE(32)
    !CLOSE(33)
...
!
  T = 0.D0
  IF((NPAS /= 0).OR.(NRUN /= 0)) OPEN(8, FILE = 'real3d-dyna.txt')  
!
  ...
  END IF  
! 
    OPEN(31, FILE = 'real3d-den.txt')
    CALL WRITE_3D(31, CP2)
    CLOSE(31)

    OPEN(11, FILE = 'real3d-den1d_z.txt')
    OPEN(12, FILE = 'real3d-den1d_x.txt')
    OPEN(13, FILE = 'real3d-den1d_y.txt')
    CALL DEN1DZ(11, CP2, DEN1Z)
    CALL DEN1DX(12, CP2, DEN1X)
    CALL DEN1DY(13, CP2, DEN1Y)
    CLOSE(11)
    ...
    !OPEN(21, FILE = 'real3d-den2d_xz.txt')
    !OPEN(22, FILE = 'real3d-den2d_xy.txt')
    !OPEN(23, FILE = 'real3d-den2d_yz.txt')
    !CALL DEN2DXZ(21, CP2, DEN2XZ)
    !CALL DEN2DXY(22, CP2, DEN2XY)
    !CALL DEN2DYZ(23, CP2, DEN2YZ)
    !CLOSE(21)
    ...
    !OPEN(32, FILE = 'real3d-den3d_x0z.txt')
    !OPEN(33, FILE = 'real3d-den3d_xy0.txt')
    !CALL WRITE_2DXZ(32, CP2)
    !CALL WRITE_2DXY(33, CP2)
    !CLOSE(32)
    !CLOSE(33)
...
!
    !OPEN(31, FILE = 'real3d-den-nrun.txt')
    !CALL WRITE_3D(31, CP2)
    !CLOSE(31)

    !OPEN(11, FILE = 'real3d-den-nrun1d_z.txt')
    !OPEN(12, FILE = 'real3d-den-nrun1d_x.txt')
    !OPEN(13, FILE = 'real3d-den-nrun1d_y.txt')
    !CALL DEN1DZ(11, CP2, DEN1Z)
    !CALL DEN1DX(12, CP2, DEN1X)
    !CALL DEN1DY(13, CP2, DEN1Y)
    !CLOSE(11)
    ...
    !OPEN(21, FILE = 'real3d-den-nrun2d_xz.txt')
    !OPEN(22, FILE = 'real3d-den-nrun2d_xy.txt')
    !OPEN(23, FILE = 'real3d-den-nrun2d_yz.txt')
    !CALL DEN2DXZ(21, CP2, DEN2XZ)
    !CALL DEN2DXY(22, CP2, DEN2XY)
    !CALL DEN2DYZ(23, CP2, DEN2YZ)
    !CLOSE(21)
    ...
    !OPEN(32, FILE = 'real3d-den-nrun3d_x0z.txt')
    !OPEN(33, FILE = 'real3d-den-nrun3d_xy0.txt')
    !CALL WRITE_2DXZ(32, CP2)
    !CALL WRITE_2DXY(33, CP2)
    !CLOSE(32)
    !CLOSE(33)
...
! 
  IF(NSTP.EQ.0)THEN
    WRITE(*,'(a)') "Run the program using the input file to read. e.g.: ./real3d < imag3d-den.txt"
    DO I=0,NX
     DO J=0,NY
      DO K=0,NZ
       READ(*,*)TMP  !READ OUTPUT of IMAGTIME PROGRAM WITH SAME PARAMETERS 
       CP(I,J,K)=SQRT(TMP) 
      END DO
     END DO
    END DO   
...
! Routine that  initializes the harmonic oscillator potential V.
  ...
  IMPLICIT NONE
  INTEGER :: J, K
  REAL (8) :: ANU2, LAM2, GAMMA2
!
  GAMMA2 = GAMMA * GAMMA
  ANU2 = ANU * ANU
  LAM2 = LAMBDA * LAMBDA
  FORALL (J=0:NY, K=0:NZ) 
    V(0:NX,J,K) = (X2 * GAMMA2 + ANU2 * Y2(J) + LAM2 * Z2(K))
  END FORALL
END SUBROUTINE CALCULATE_TRAP
...
!  derivative term using the Crank-Nicholson method 
  ...
  COMPLEX (8), DIMENSION(0:,0:,0:), INTENT(INOUT) :: CP
  INTEGER :: I,J,K
  COMPLEX (8), DIMENSION(0:NX,0:NY,0:NZ) :: CBE,CXX
...
!  derivative term using the Crank-Nicholson method
  ...
  COMPLEX (8), DIMENSION(0:,0:,0:), INTENT(INOUT) :: CP
  INTEGER :: J,I,K
  COMPLEX (8) :: CBE(0:NX,0:NY,0:NZ), CYY(0:NX,0:NY,0:NZ)
!
  DO I=0,NX
   DO K=0,NZ
...
!  derivative term using the Crank-Nicholson method
  ...
  COMPLEX (8), DIMENSION(0:,0:,0:), INTENT(INOUT) :: CP
  INTEGER :: K,I,J
  COMPLEX (8) :: CBE(0:NX,0:NY,0:NZ), CZZ(0:NX,0:NY,0:NZ)
!
  DO I=0,NX
   DO J=0,NY
